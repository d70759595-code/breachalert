        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <section className="lg:col-span-2 bg-[#121212] rounded-3xl p-6 sm:p-8 border border-white/[0.08] backdrop-blur-xl">
            ...
            <form onSubmit={handleSave} className="space-y-4">
              ...
              <div>
                <label className="font-mono text-[10px] uppercase tracking-widest text-[#969696] mb-1.5 block">Mobile Phone Number (for SMS Emergency Alerts)</label>
                <input
                  type="tel"
                  value={phoneNumber}
              ...
              <div className="flex items-center gap-3 pt-2">
                <input
                  ...
                  className="w-4 h-4 rounded border-white/20 bg-[#181818] text-[#FF6A2A] focus:ring-0"
                />
                <label htmlFor="smsEnabledToggle" className="text-xs text-white cursor-pointer select-none">
                  Enable Instant SMS Emergency Alerts (Family Plan Feature)
                </label>
              </div>

              <button
                type="submit"
                className="bg-[#FF6A2A] hover:bg-[#FF7A3D] text-black font-semibold text-xs uppercase font-mono px-5 py-2.5 rounded-full transition-all shadow-md mt-4"
              >
